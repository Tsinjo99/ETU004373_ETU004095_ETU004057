...
const montantHtSpan = document.getElementById('montant-ht');
const montantFraisSpan = document.getElementById('montant-frais');
const montantTotalSpan = document.getElementById('montant-total');
const fraisPourcent = <?= $frais_achat ?>;
...
function updateApercu() {
    ...
    if (prix > 0 && quantite > 0) {
        ...
        montantHtSpan.textContent = montantHt.toLocaleString('fr-FR');
        montantFraisSpan.textContent = montantFrais.toLocaleString('fr-FR');
